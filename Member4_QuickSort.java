...
// Below codes are for individual memebers to implement their own algorithmas seperately //
 ...
 // I'm member 2 my role is to Implement Binary Search — sort the array first, then measure search
...
//Below codes are for individual memebers to implement their own algorithmas seperately //
  ...
  //I'm member 3 my role is to Implement Bubble sort
...
public class Member3_BubbleSort {
    ...
    // Member 3's task: Bubble Sort time measurement
    
    public static long timeBubbleSort(int size) {
        int[] data = generateRandomArray(size);
        long startTime = System.nanoTime(); [cite: 30]
        ...
        long endTime = System.nanoTime(); [cite: 30]
        return endTime - startTime;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------------------------------------------");
        System.out.println("Member 3: Bubble Sort"); [cite: 33]
        printTable("Bubble Sort", inputSizes, Member3_BubbleSort::timeBubbleSort);
        System.out.println("-----------------------------------------------------------------");
    }
...
//I'm member 4 my role is to Implement QuickSort
...
public class Member4_QuickSort {
    ...
    // Member 4's task: Measuring Quick Sort time
    
    public static long timeQuickSort(int size) {
        int[] data = generateRandomArray(size);
        long startTime = System.nanoTime(); [cite: 30]
        
        // Quick Sort Algorithm (Recursive helper function used)
        quickSort(data, 0, data.length - 1);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------------------------------------------");
        System.out.println("Member 4: Quick Sort");
        printTable("Quick Sort", inputSizes, Member4_QuickSort::timeQuickSort);
        System.out.println("-----------------------------------------------------------------");
    }
